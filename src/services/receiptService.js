...
export const generateReceiptData = (transaction, shop, companyInfo) => {
    return {
      company: {
        name: companyInfo?.name || 'The Place',
        address: companyInfo?.address || 'Kianjiru, Kenya',
        phone: companyInfo?.phone || '+254 746082039',
        email: companyInfo?.email || 'ichigoeliud021@gmail.com',
